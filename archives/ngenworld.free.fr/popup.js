function popupChat() {
        win=window.open("popup.html", "N-Gen",
...
function send()
{
 ...
 win.document.write('<html><head><title>N-Gen</title><noscript> </head></noscript>')
 ...
 win.document.write('<param name="ServerName1" value="irc.efnet.org">')

 win.document.write('<param name="Channel1" value="#n-gen">')

 win.document.write('<param name="AllowURL" value="true">')
 win.document.write('<param name="AllowIdentd" value="true">')
 win.document.write('<param name="WelcomeMessage" value="Bienvenue sur le channel N-Gen !">')
 win.document.write('<param name="RealName" value="N-Gen Visitor">')
 win.document.write('<param name="NickName" value="'+USERNICK+'">')
 win.document.write('<param name="UserName" value="ngen">')
